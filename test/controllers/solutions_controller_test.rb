...
class SolutionsControllerTest < ActionController::TestCase
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post :create, solution: { code: @solution.code, problem_id: @solution.problem_id, user_id: @solution.user_id }
    end
  ...
  test "should update solution" do
    patch :update, id: @solution, solution: { code: @solution.code, problem_id: @solution.problem_id, user_id: @solution.user_id }
    assert_redirected_to solution_path(assigns(:solution))
  end
